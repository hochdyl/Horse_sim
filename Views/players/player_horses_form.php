<main class="container-md">
    <section class="mb-3">
        ...
        <form method="post">
            ...
            <input class="form-control" type="number" name="horse_id" id="horse_id" placeholder="Horse ID" value="<?php if (isset($data)): echo $data[1]; endif; ?>" required>
            <hr>
            <?php if (isset($data)): ?>
            ...
            <?php endif; ?>
            <a href="<?= ROOT ?>player/horses" class="no-decoration"><button type="button">Retour</button></a>
