<main class="container-md">
    <section class="mb-3">
        ...
        <form method="post">
            ...
            <input class="form-control" type="number" name="weather_id" id="weather_id" placeholder="Weather ID" value="<?php if (isset($data)): echo $data[1]; endif; ?>" required>
            <hr>
            <?php if (isset($data)): ?>
            ...
            <?php endif; ?>
            <a href="<?= ROOT ?>newspapers" class="no-decoration"><button type="button">Retour</button></a>
